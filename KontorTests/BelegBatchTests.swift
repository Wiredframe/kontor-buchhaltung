...
struct BelegEntwurfOCRTests {
    ...
    @Test func ocrUeberschreibtGetippteAusgabeNicht() {
        ...
        e.fuelle(
            BelegDaten(
                anbieter: "Hotal Berlni", datum: tag(2026, 6, 12),
    ...
    @Test func ocrOhneBetragNulltDieEingabeNicht() {
        ...
        e.fuelle(
            BelegDaten(
                anbieter: nil, datum: nil, brutto: nil, vst: nil,
    ...
    @Test func ocrUeberschreibtGetippteEinnahmeNicht() {
        ...
        e.fuelle(
            EinnahmeDaten(
                kunde: "Kranzier Digitai", datum: tag(2026, 6, 12),
    ...
    @Test func unberuehrterEntwurfWirdVollGefuellt() {
        ...
        e.fuelle(
            BelegDaten(
                anbieter: "Figma", datum: tag(2026, 6, 12), brutto: dez("35"),
...
struct BelegBatchTests {
    ...
    @Test func zusammenfuehrenDannTrotzdemNeuAnlegen() throws {
        let c = try container()
        let claude = ExpenseEntry(
            datum: tag(2026, 6, 28), bezeichnung: "Claude Pro", anbieter: "Anthropic",
            brutto: dez("18"), vst: 0, steuerart: .reverseCharge)
        c.mainContext.insert(claude)
        ...
        e.zusammenfuehren(modus: .ausgabe, in: c.mainContext)
        try c.mainContext.save()
        ...
        e.anlegenOderAktualisieren(modus: .ausgabe, in: c.mainContext)
        try c.mainContext.save()
