...
struct BelegOCRTests {
    ...
    /// ```
    ///
    /// Ohne gesetzte Variable passiert nichts. Genau diese Lücke – synthetische Fixtures liefen
    /// grün, während echte Rechnungen schlechter erkannt wurden – hat einen ersten Anlauf zur
    /// Härtung der Erkennung wieder gekostet.
