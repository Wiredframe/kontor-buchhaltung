...
struct PrivateAusgabenAggregateTests {
    ...
    @Test func privateEinmaligeAusgabeFaelltNichtDurchsRaster() {
        let sneaker = ExpenseEntry(
            datum: tag(2026, 6, 12), bezeichnung: "Sneaker", anbieter: "",
    ...
    @Test func wiederkehrendesZaehltNichtAlsEinmalig() {
        let liste = [
            ExpenseEntry(
                datum: tag(2026, 6, 1), bezeichnung: "Miete", anbieter: "",
                brutto: dez("725"), vst: 0, steuerart: .steuerfrei,
                betrieblich: false, art: .fixkosten),
            ExpenseEntry(
                datum: tag(2026, 6, 3), bezeichnung: "Netflix", anbieter: "",
    ...
    @Test func betrieblicheEinmaligeAusgabeZaehltNichtAlsPrivat() {
        let liste = [
            ExpenseEntry(
                datum: tag(2026, 6, 12), bezeichnung: "Monitor", anbieter: "",
...
struct ModellTests {
    ...
    @Test func mischrechnungBucketsUndAggregate() {
        ...
        let inc = Income(
            kunde: "Studio X", rnNetto: dez("2000"), ust: dez("380"),
    ...
    @Test func vorlage7ProzentBuchtKorrekteVorsteuer() {
        ...
        let buch = Vorlage(
            bezeichnung: "Fachbuch", betragBrutto: dez("42.80"), steuerart: .inland7,
            betrieblich: true, art: .betriebsausgabe)
    ...
    @Test func vorlageErzeugtDatierteBuchung() {
        ...
        let miete = Vorlage(
            bezeichnung: "Miete", betragBrutto: 1000, steuerart: .steuerfrei,
            betrieblich: false, art: .fixkosten)
        ...
        let adobe = Vorlage(
            bezeichnung: "Adobe", betragBrutto: dez("59.49"), steuerart: .inland19,
    ...
    @Test func snapshotEinfrierenUndEntsperren() {
        ...
        let snap = MonatsSnapshot(
            rn: dez("4000"), ust: dez("760.00"), vst: 0, ustKorrektur: 0,
